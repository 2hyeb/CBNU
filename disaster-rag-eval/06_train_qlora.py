#!/usr/bin/env python
"""06_train_qlora.py — QLoRA fine-tuning for EXAONE / LLaMA / Qwen3"""
...
def main():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        dtype=torch.float16,
        # attn_implementation="flash_attention_2",  # not supported on cc<8.0
    )
